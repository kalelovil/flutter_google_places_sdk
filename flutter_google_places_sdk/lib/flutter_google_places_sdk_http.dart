...
class FlutterGooglePlacesSdkHttpPlugin extends FlutterGooglePlacesSdkPlatform {
  ...
  String _addUrlParam(String name, LatLng point) {
    return '&$name=${point.lat}%2C${point.lng}';
  }
}

extension _LatLngExt on LatLngBounds {
  double get radius {
  ...
  LatLng get center {
    ...
    return LatLng(lat: latMiddle, lng: lngMiddle);
  }
}
